...
def get_data_from_file(path):
    ...
    with open(path, encoding='utf-8') as people_file:
        return people_file.read().split('\n') #Combination of the required steps
...
def main():
    ...
    raw_data = get_data_from_file('D:\Schulungen\Data_Analyst\Python_Training\People_Data\people_data.txt')
